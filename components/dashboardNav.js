...
export default function DashboardNav({ show, hideNav = (f) => f }) {
  const inactiveLink = "flex gap-1 p-1 pr-5";
  const activeLink = inactiveLink + " text-black bg-highlight rounded-l-sm";
      ...
      <nav className="flex flex-col gap-5">
        ...
        >
          <svg
            ...
            stroke="currentColor"
            className={
              pathname.includes("customers") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        <Link
          ...
          onClick={hideNav}
          className={pathname.includes("analytics") ? activeLink : inactiveLink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            stroke="currentColor"
            className={
              pathname.includes("analytics") ? activeIcon : inactiveIcon
            }
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.includes("profile") ? activeIcon : inactiveIcon}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
