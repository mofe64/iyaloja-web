...
const projects = [
  ...
  },
  {
    id: 2,
    name: "Barack Obama",
    href: "/dashboard/invoices/2/details",
    status: "Unpaid",
    amount: "2,5000,000",
    dueDate: "May 5, 2023",
  ...
  },
  {
    id: 3,
    name: "FoodCo",
    href: "/dashboard/invoices/3/details",
    status: "Paid",
    amount: "100,000",
    dueDate: "May 25, 2023",
  ...
  },
  {
    id: 4,
    name: "Apple Co",
    href: "/dashboard/invoices/4/details",
    status: "Paid",
    amount: "1,240,000",
    dueDate: "June 7, 2023",
  ...
  },
  {
    id: 5,
    name: "Toni Tones",
    href: "/dashboard/invoices/5/details",
    status: "Unpaid",
    amount: "300,000",
          ...
          >
            <div className="min-w-0">
              ...
              <div className="mt-1 flex items-center gap-x-2 text-xs leading-5 text-gray-500">
                ...
                <p className="truncate">Amount: {project.amount}</p>
              </div>
            </div>
            <div className="flex flex-none items-center gap-x-4">
              ...
              >
                Invoice details<span className="sr-only">, {project.name}</span>
              </a>
